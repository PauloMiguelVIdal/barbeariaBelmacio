document.addEventListener("DOMContentLoaded", () => {
    ...
    const containerInicialC = document.getElementById("containerInicialC")
    ...
    const containerInicialB = document.getElementById("containerInicialC")
    ...
    const containerInicialBC = document.getElementById("containerInicialC")
